...
\begin{frame}{Implementation: se\_vault}
    Genode includes \textbf{file\_vault} + \textbf{Tresor} library:
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Added \textbf{fsck} crash recovery support
...
\begin{frame}{Results}
    ...
    \bigskip
    Default QEMU \texttt{-cpu Nehalem-v2} disables AES/SHA hardware acceleration;
    switching to \texttt{-cpu host} improved results significantly,
    but overhead remains high.
\end{frame}
