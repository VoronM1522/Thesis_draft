...
\begin{frame}{Usage scenarios 1}
    \begin{tikzpicture}[remember picture,overlay]
        \node[anchor=north,inner sep=0pt,yshift=0.5cm] at (current page.north) {
...
\begin{frame}{Usage scenarios 2}
    \begin{tikzpicture}[remember picture,overlay]
        \node[anchor=south,inner sep=0pt,yshift=0.5cm] at (current page.south) {
            \includegraphics[height=2\paperheight]{src/use_cases.pdf}
        };
    \end{tikzpicture}
\end{frame}
